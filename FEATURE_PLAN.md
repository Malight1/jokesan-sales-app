...
**Starts from:** migrations 0001–0027, all live in production — everything through Phase 5a. Work now commits directly to `main` (no feature branches — see `HANDOVER.md`'s hard constraints).
